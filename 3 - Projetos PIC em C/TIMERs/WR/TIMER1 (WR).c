...
#include <reg_16f.h>
/*
	> f = 1/T >> T = 1/f (maior f, menor T - mais rápido; menor f, maior T - menos rápido)
	> Timer1: 16 bits
	> clk = 20MHz (cristal/interno) >> Temporizador
	> Ciclo de máquina = 4/clk = 4/20000000Hz = 0,0000002s = 0,2us
	> Tempo do estouro = TMR1 * prescaler * ciclo de máquina =  65536*1*0,2us = 13,12ms
*/

void main()
{
	TRISC = 0;
	T1CON = 0b00000000; // Sem divisão de frequência, sincronia com o clk, bit ignorado, clk interno, TMR1 desabiitado
}
*/